...
// gcc/clang
//   times  M1: 
//https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/spectralnorm-gcc-5.html
// - single-core: c++  -std=c++17 -O3 -o cspectral-norm spectral-norm.cpp; time ./cspectral-norm 5500
