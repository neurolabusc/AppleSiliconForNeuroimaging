...
! gFortran
!   times  M1: 2.730
!   https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-gfortran-2.html
! - single-core: gfortran -O3 -o fbinarytrees binarytrees.f90 -lapr-1; time ./fbinarytrees 21
