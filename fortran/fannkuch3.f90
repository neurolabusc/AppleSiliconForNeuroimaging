...
! gFortran
!   https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/fannkuchredux-gfortran-3.html
! - single-core: gfortran -O3 -o ffannkuch3 fannkuch3.f90; time ./ffannkuch3 12
! - multi-core: gfortran -openmp -O3 -o ffannkuch3 fannkuch3.f90; time ./ffannkuch3 12 
