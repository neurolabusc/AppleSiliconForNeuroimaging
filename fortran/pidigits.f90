...
! gFortran
!   https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/pidigits-gfortran-4.html
! - single-core: gfortran -O3 -o fpidigits pidigits.f90 -lgmp; time ./fpidigits 10000
